...
export const UserLayout: React.FC<{ children: React.ReactNode }> = ({
  ...
  const sidebarItems = React.useMemo(
    () => [
      { icon: <House />, label: "Home", isActive: false, link: "/home", notificationCount: 0 },
      { icon: <Library />, label: "My Library", link: "/library", notificationCount: 0 },
      { icon: <Bell />, label: "Notifications", notificationCount, link: "/notifications" },
      { icon: <Bookmark />, label: "Watch Later", notificationCount: 1, link: "/watchlater" },
      { icon: <History />, label: "History", notificationCount: 0, link: "/history" },
      { icon: <Settings />, label: "Settings", notificationCount: 0, link: "/settings" },
    ],
    [notificationCount]
  );
